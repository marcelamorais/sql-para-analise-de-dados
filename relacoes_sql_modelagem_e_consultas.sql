/*
=========================================================
Projeto: Fundamentos de SQL - Relacionamentos e Consultas
Arquivo: relacoes_sql_modelagem_e_consultas.sql

Descrição:
Este script demonstra a criação de um banco de dados
relacional com tabelas de clientes, produtos e pedidos.
Inclui inserção de dados e consultas analíticas utilizando
inner join, left join, funções de agregação e filtros.
